      ...
      <Grid
            ...
            >
                <Grid item xs={12}>
                    ...
                    >
                        <CardHeader
                            className={classes.bot} title='Sign up' color="secondary" variant="h4" style={{ fontFamily: 'cursive', fontWeight: 'bold', marginTop: "0px", paddingLeft: "15px", backgroundImage: 'linear-gradient(45deg, #FE6B8B 30%, #FF8E53 90%)', border: 0  }}
                        />
                        <CardActionArea>
                            <CardContent>
